...
useEffect(()=>{
  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-center py-20 bg-gray-300 max-md:px-4 '>
        <Title title='Avilable car' subTitle=" Browse Our selection of premium wehicles available for your adventure"/>
